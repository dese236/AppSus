...
export class Edit extends React.Component {
    ...
    render() {
        ...
        const { title, noteType , todos , color} = this.state.note
        return (
            <section className="edit" onClick={this.setClick}>
                <form autoComplete="off"  className="note-form" onSubmit={this.onSubmit}>
